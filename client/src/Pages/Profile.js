    ...
    return (
        <div style={{ textAlign: "center" }}>
            ...
            <div style={{ marginTop: "90px" }}>
                <p style={{ fontSize: "2rem", fontWeight: "600", margin: "0" }} >Avni</p>
                <p style={{ fontSize: "1.2rem", fontWeight: "400", margin: "0" }} >email</p>
                <p style={{ fontSize: "1.2rem", fontWeight: "400", margin: "0" }} >8295500639</p>
            </div>
